...
def process_ih(file_path):
    try:
        ...
        dataset['In House Date'] = pd.to_datetime(dataset['In House Date'], format='%d/%m/%Y')
        dataset['Arrival'] = pd.to_datetime(dataset['Arrival'], format='%d/%m/%Y')
        dataset['Depart'] = pd.to_datetime(dataset['Depart'], format='%d/%m/%Y')
        dataset['Created'] = pd.to_datetime(dataset['Created'], format='%d/%m/%Y')
